        ...
        docs.map((doc)=>{ 
           return <div>
            ...
            <div class="inline-flex rounded-md shadow-sm mb-4" role="group">
                <button type="button" class=" px-4 py-2 text-sm font-medium border  border-gray-600  rounded-l-lg focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
