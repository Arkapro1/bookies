          ...
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="mb-8 leading-relaxed text-gradient-purple-green">
              <ul class=" list-inside">
                <li class="mb-2">
                  <strong class="text-blue-500">Seamless Organization:</strong>{" "}
                  Effortlessly categorize and nest bookmarks for quick
                  retrieval.
                </li>
                <li class="mb-2">
                  <strong class="text-blue-500">Universal Access:</strong>{" "}
                  Access your bookmarks anytime, anywhere, across all devices.
                </li>
                <li class="mb-2">
                  <strong class="text-blue-500">
                    Intelligent Suggestions:
                  </strong>{" "}
                  Discover new content with personalized bookmark
                  recommendations.
                </li>
                <li class="mb-2">
                  <strong class="text-blue-500">Effortless Sharing:</strong>{" "}
                  Collaborate by sharing curated folders with friends and
                  colleagues.
                </li>
              </ul>
            </div>
